...
const ChartSection = ({name,amount}) => {
    return (
        <ChartSectionStyled>
           <InnerLayout>
               <div className="chart-con">
                    <div className="chart-left">
                        <div className="stats">
                                <div className="stats-money">
                                    ...
                                    <ChartStats  name={"Last Transaction"} amount={"$950"} />
                                </div>
                                <img
                                src={chart}
                                alt="chart"
                    ...
                    <div className="chart-right">
                        ...
                        whether it is a business, a non-profit organization, or a government body. 
                        It is the art and science of managing resources.
                        </p>
